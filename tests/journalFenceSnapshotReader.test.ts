...
const row=(event_id:string, event_type:string, order_hash:string|null=ORDER, chain:string|null="gunzilla", contract_address:string|null=CONTRACT, token_id:string|null="6394148"):Row=>({event_id,event_type,event_version:"1",order_hash,chain,contract_address,token_id,received_at:new Date("2026-01-01T00:00:00.000Z")});
