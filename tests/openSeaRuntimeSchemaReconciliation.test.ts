...
test("runtime metadata is repinned to the immutable Task-32 evidence", () => {
  ...
  assert.equal(OPENSEA_ORDER_CONTRACT_VERSION, "opensea-get-order-v3-2026-09");
  assert.equal(OPENSEA_EXACT_ORDER_ADAPTER_VERSION, "opensea-exact-order-adapter-v11-2026-09");
