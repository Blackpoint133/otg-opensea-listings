...
export const TARGETED_VERIFIER_POLICY_VERSION = "targeted-verifier-policy-v5" as const;
export const OPENSEA_ORDER_CONTRACT_VERSION = "opensea-get-order-v1-2026-05" as const;
export const TARGETED_VERIFIER_NORMALIZER_VERSION = "targeted-verifier-normalizer-v2-2026-09" as const;
