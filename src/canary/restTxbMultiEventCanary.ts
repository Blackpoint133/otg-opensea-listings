...
export const MULTI_REST_TXB_TARGET_IDS = ["84", "85"] as const;
export const MULTI_REST_TXB_ORDERED_IDS = ["85", "84"] as const;
...
const EXPECTED = {
  ...
  "85": { eventId: "85", eventTimestamp: "2026-08-13T10:55:39.000Z", tokenId: "48804195", transactionHash: "0xc84ca6c38b22208693661f5f8368092a700f831fbf176997cf6036388593e5fb", dedupeKey: "transfer:v1:1d4b20c2f0f9c1d72a942fda63e71775c8ae7d4d9ff63599e10694671c94e6e6", canonicalTo: "0x40d230ac7ca93dbb781edf25c57542bc4af430ca" }
} as const;
...
const SOURCE_FILES = [
  "src/canary/restTxbMultiEventCanary.ts", "src/canary/runRestTxbMultiEventCanary.ts", "src/runtime/runtimeGuard.ts",
...
const RUNTIME_FILES = ["dist/canary/restTxbMultiEventCanary.js", "dist/canary/runRestTxbMultiEventCanary.js"] as const;
...
export function loadRestTxbMultiEventConfig(argv: string[]): MultiRestTxbConfig {
  ...
  if (eventIds !== "84,85") throw new Error("multi-event canary is hard-pinned to --event-ids 84,85");
...
export function validateMultiRestTxbEventSuccess(before: MultiRestTxbSnapshot, after: MultiRestTxbSnapshot, applied: PendingInboxApplyResult, id: string): string[] {
  ...
  const expected = EXPECTED[id as "84" | "85"];
