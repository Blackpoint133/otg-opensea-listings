...
import { loadRestTxbMultiEventConfig, runRestTxbMultiEventCanary, type MultiRestTxbSummary } from "./restTxbMultiEvent8486Canary.js";
...
if (process.argv[1]?.replace(/\\/g, "/").endsWith("/dist/canary/runRestTxbMultiEvent8486Canary.js")) void runRestTxbMultiEventCanaryCli().then((result) => { process.exitCode = result.exitCode; });
