...
function input(body: Uint8Array | null = raw(), extra: Record<string, unknown> = {}) { return { context, httpStatus: 200, body, requestStartedAt: "2030-01-01T00:00:00.000Z", responseHeadersAt: "2030-01-01T00:00:00.500Z", responseCompletedAt: "2030-01-01T00:00:01.000Z", headers: { date: "Tue, 01 Jan 2030 00:00:00 GMT", "content-type": "application/json", "content-encoding": "identity" }, ...extra }; }
